            ...
            <div class="col-md-12">
                ...
                <input type="hidden" name="songid" id="songid" value="{{ $song->_id}}">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="title_song" id="title_song" value="{{ $song->title_song }}" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="duration" id="duration" value="{{ $song->duration }}" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="album" id="album" class="form-control" disabled>
